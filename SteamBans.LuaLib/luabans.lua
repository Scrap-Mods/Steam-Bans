...
---@field SetUserAccess fun(self: ISteamBans, steamid: string, access: AccessType): nil Sets the access rights for a specific user.
---@field GetUserAccess fun(self: ISteamBans, steamid: string): AccessType Retrieves the access rights for a specific user.
...
---@field SetGlobalAskCallback fun(self: ISteamBans, callback: fun(steamid: string, old: string, new: string): AccessType): nil Sets the global access callback.
---@field SetUserAskCallback fun(self: ISteamBans, steamid: string, callback: fun(steamid: string, old: string, new: string): AccessType): nil Sets the access callback for a specific user.
---@field SetFriendsAskCallback fun(self: ISteamBans, callback: fun(steamid: string, old: string, new: string): AccessType): nil Sets the access callback for all of user's friends.
---@field SetBlockedAskCallback fun(self: ISteamBans, callback: fun(steamid: string, old: string, new: string): AccessType): nil Sets the access callback for all of user's blocked users.
...
---@field CloseConnection fun(self: ISteamBans, steamid: string, reason: integer, message: string, linger: boolean): nil Closes a connection to a user.
